...
async function getAxios() {
  if (!axiosModule) {
    axiosModule = await import("./axios-KOXFKK5G.js");
  }
...
async function getIsIPFS() {
  if (!isIPFSModule) {
    isIPFSModule = await import("./src-2O2QUPMX.js");
  }
  return isIPFSModule;
}
...
var getCid = async (config, cid, options) => {
  ...
  try {
    ...
    const contentType = ((_a = request.headers.get("content-type")) == null ? void 0 : _a.split(";")[0]) || null;
...
//# sourceMappingURL=pinata-web3.js.map
